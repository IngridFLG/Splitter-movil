...
class ConceptoResultadoPage extends StatefulWidget {
  static const name = 'conceto-resultado-page';
  const ConceptoResultadoPage({super.key});

  @override
  State<ConceptoResultadoPage> createState() => _ConceptoResultadoPageState();
}

class _ConceptoResultadoPageState extends State<ConceptoResultadoPage> {
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Column(children: [
                            ...
                            texto('Resultados del conepto de fracción', fontApp,
