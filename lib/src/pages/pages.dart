...
export 'package:splitter_movil_frontend/src/pages/temas/simplificar/ejemplos_simp_page.dart';
export 'package:splitter_movil_frontend/src/pages/temas/simplificar/ejercicio_simp_page.dart';

// Equivalencia
export 'package:splitter_movil_frontend/src/pages/temas/equivalencia/equivalencia_page.dart';
export 'package:splitter_movil_frontend/src/pages/temas/equivalencia/ejercicio_equi_page.dart';
...
export 'package:splitter_movil_frontend/src/pages/resultados/concepto_resultado_page.dart';
export 'package:splitter_movil_frontend/src/pages/resultados/simplificar_resultado_page.dart';
export 'package:splitter_movil_frontend/src/pages/resultados/equivalencia_resultado_page.dart';
export 'package:splitter_movil_frontend/src/pages/resultados/sumar_resultado_page.dart';
export 'package:splitter_movil_frontend/src/pages/resultados/multi_resultado_page.dart';